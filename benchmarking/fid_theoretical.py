...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_a', type=str, default='/home/longzhihao/dataset/few_shot_images_datasets/100-shot-grumpy_cat')
    parser.add_argument('--path_b', type=str, default='/home/longzhihao/dataset/few_shot_images_datasets/100-shot-grumpy_cat_theoreticcl')
    ...
    if os.path.exists(os.path.join(args.path_b)):
        dset_b = ImageFolder(os.path.join(args.path_b), transform)
