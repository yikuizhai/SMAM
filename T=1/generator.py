...
class Generator1(nn.Module):
    ...
    def forward(self, input, skips=False):
        if skips:
            ...
            feat_128_alignment = self.to_128(feat_128)

            feat_128_residual_frequency = self.get_feat_128_residual_frequency(feat_64)
            feat_128_residual_frequency_alignment = self.feat_128_residual_fequency_output(feat_128_residual_frequency)

            feat_256_alignment = self.upsample(feat_128_alignment)
            ...
            if self.im_size == 256:
                return [complete_feat_256, feat_128_alignment], [feat_256_residual_frequency_alignment, feat_128_alignment]
            ...
            if self.im_size == 512:
                return [complete_feat_512, complete_feat_256, feat_128_alignment], [feat_512_residual_frequency_alignment, feat_256_residual_frequency_alignment, feat_128_alignment]
            ...
            return [im_1024, complete_feat_512, complete_feat_256, feat_128_alignment], [feat_1024_residual_frequency_alignment, feat_512_residual_frequency_alignment, feat_256_residual_frequency_alignment, feat_128_alignment]


# high_num=2
class Generator2(nn.Module):
    def __init__(self, ngf=64, nz=100, nc=3, im_size=1024, kernel_size=7, num_high=7):
    ...
    def forward(self, input, skips=False):
        if skips:
            ...
            feat_64_residual_frequency = self.get_feat_64_residual_frequency(feat_32)
            feat_64_alignment = self.to_64(feat_64)

            feat_128_alignment = self.upsample(feat_64_alignment)
            ...
            if self.im_size == 256:
                return [complete_feat_256, complete_feat_128, feat_64_alignment], [feat_256_residual_frequency_alignment, feat_128_residual_frequency_alignment, feat_64_alignment]
            ...
            if self.im_size == 512:
                return [complete_feat_512, complete_feat_256, complete_feat_128, feat_64_alignment], [feat_512_residual_frequency_alignment, feat_256_residual_frequency_alignment, feat_128_residual_frequency_alignment, feat_64_alignment]
            ...
            return [im_1024, complete_feat_512, complete_feat_256, complete_feat_128, feat_64_alignment], [feat_1024_residual_frequency_alignment, feat_512_residual_frequency_alignment, feat_256_residual_frequency_alignment, feat_128_residual_frequency_alignment, feat_64_alignment]
